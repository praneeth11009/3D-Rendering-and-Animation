...
csX75::HNode* get_stool1(float size,glm::vec4 offset)
{
	...
	csX75::HNode* leg1 = ellipsoid(r3,r3,r3,r3,h3,glm::vec4(0,0,0,1),0.6,stool1_back,darkskincolor,darkskincolor);
	leg1->set_constraints(0,0,0,0,0,0);
	leg1->change_parameters(0, 3*r3, 0, 90, 0, 120, size);

	csX75::HNode* leg2 = ellipsoid(r3,r3,r3,r3,h3,glm::vec4(0,0,0,1),0.6,stool1_back,darkskincolor,darkskincolor);
	leg2->set_constraints(0,0,0,0,0,0);
	leg2->change_parameters(0, 3*r3, 0, 90, 0, -120, size);

	csX75::HNode* leg3 = ellipsoid(r3,r3,r3,r3,h3,glm::vec4(0,0,0,1),0.6,stool1_back,darkskincolor,darkskincolor);
